...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Inventario</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="size" class="control-label">Tamanio</label>
            ...
            <div class="form-group">
				<label for="unit" class="control-label">Unidades</label>
