...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> SubCategoria</h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
            <div class="form-group">
				<label for="parent_id" class="control-label">Categoría principal</label>
			...
			<div class="form-group">
				<label for="sub_category" class="control-label">SubCategoria Nombre</label>
