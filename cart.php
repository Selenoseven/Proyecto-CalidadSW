                    ...
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            ...
                            <div>
                                ...
                                <p class="mb-1 mb-sm-1"><small><b>Tamanio:</b> <?php echo $row['size'] ?></small></p>
                                <p class="mb-1 mb-sm-1"><small><b>Precio:</b> <span class="price"><?php echo number_format($row['price'], 2, '.', ',') ?></span></small></p>
                                <div>
...
<script>
    ...
    // Agregar 2 decimales a todos los totales
    ...
    $('#grand-total').text(total.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2}));
}
    ...
    $(function() {
        ...
        $('#empty_cart').click(function() {
            // empty_cart()
            _conf("¿Estás seguro de vaciar tu lista de compras?", 'empty_cart', [])
        })
        $('.rem_item').click(function() {
            _conf("¿Está seguro de eliminar el artículo de la lista del carrito?", 'rem_item', [$(this).attr('data-id')])
        })
    })
</script>