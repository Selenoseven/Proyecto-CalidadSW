...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?>Crear paquete</h3>
	</div>
	<div class="card-body">
		<form action="" id="package-form">
            ...
            <div class="form-group">
				<label for="tour_location" class="control-label">Ubicación del recorrido</label>
            ...
            <div class="form-group">
				<label for="" class="control-label">Imagenes</label>
